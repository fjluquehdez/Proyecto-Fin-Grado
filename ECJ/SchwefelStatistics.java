...
public class SchwefelStatistics extends Statistics {
    ...
    public void finalStatistics(final EvolutionState state, final int result) {
        ...
        try {
            FileWriter writer = new FileWriter("schwefel_resultados.csv", true);
            File file = new File("schwefel_resultados.csv");
