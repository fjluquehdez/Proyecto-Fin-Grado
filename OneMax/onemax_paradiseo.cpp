 ...
 * @file onemax.cpp
 * @author fjluque
 * @brief compilar con > c++ onemax_paradiseo.cpp -I../eo/src -I../edo/src -std=c++17 -L./lib/ -leo -leoutils -o onemax_paradiseo
 * @brief ejecutar con ./onemax_paradiseo -p <tamanio_poblacion> -c <probabilidad_cruce> -i <id>
 * @version 0.1
 * @date 2025-04-03
 *
